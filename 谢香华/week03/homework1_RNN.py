...
rnn_dataset = CharRNNDataset(texts,number_labels,char_to_index,max_len)
dataloader=DataLoader(dataset=rnn_dataset,batch_size=32,shuffle=True)
...
model=RNNClassifier(vocab_size=vocab_size,embedding_dim=embedding_dim,hidden_dim=hidden_dim,output_dim=output_dim)
